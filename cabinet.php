...
$res = mysqli_query($conn,"SELECT * FROM products Where binary cat = 'cabinet'");
...
<head>
    ...
    <script src="https://code.jquery.com/jquery-3.3.1.slim.min.jss"></script>
...
<div class="series text-center ">
            <h1>Cabinets</h1>
            <p>Choose from the best and exclusive collection of Cabinets which are beautiful looking and best in class. </p>
        </div>
