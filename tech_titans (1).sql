...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2021 at 07:36 AM
...
INSERT INTO `customers` (`id`, `email`, `name`, `phone`, `address`, `city`, `state`, `country`, `total_amount`) VALUES
(1, 'dsfds@gdg.vf', 'udit gupta', 2147483647, 'abcdsdjdwi23124', 'lucknow', 'uttar pradesh', 'India', 77600);
...
(15, 'umama saleem', 'umamasa18@gmail.com', 'umama');
