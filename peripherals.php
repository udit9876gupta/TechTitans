...
$res = mysqli_query($conn,"SELECT * FROM products Where binary cat = 'peripherals'");
...
<div class="series text-center ">
            <h1>Peripherals</h1>
            <p>Choose from the best and exclusive collection of peripheral devices from razer, asus and other top brands.</p>
        </div>
