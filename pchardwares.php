...
$result = mysqli_query($conn,"SELECT * FROM products Where binary cat = 'cpu'");
$res = mysqli_query($conn,"SELECT * FROM products Where binary cat = 'gpu'");
...
<div class="series text-center ">
            <h1>CPUs and GPUs</h1>
            <p>Choose from the best and exclusive collection of CPUs and GPUs from intel and AMD series.</p>
        </div>

<hr>
<h1 class="series">CPU</h1>
<hr>
        <div class="row">
