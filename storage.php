...
$res = mysqli_query($conn,"SELECT * FROM products Where binary cat = 'hdd'");
$result = mysqli_query($conn,"SELECT * FROM products Where binary cat = 'ssd'");
...
<div class="series text-center ">
            <h1>Secondary Memory</h1>
            <p>Choose from the best and exclusive collection of secondary storage including both SSDs and Hard Disk Drives for fast storage.</p>
        </div>
        <hr>
        <h1 class="series">HDD</h1>
        <hr>
        <div class="row">
