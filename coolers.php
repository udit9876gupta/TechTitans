...
$res = mysqli_query($conn,"SELECT * FROM products Where binary cat = 'air'");
$result = mysqli_query($conn,"SELECT * FROM products Where binary cat = 'liquid'");
...
<div class="series text-center ">
            <h1>Coolers</h1>
            <p>Choose from the best and exclusive collection of liquid as well as air coolers.</p>
        </div>
        <hr>
        <h1 class="series">Air Coolers</h1>
        <hr>
        <div class="row">
    ...
    <?php
            ...
            <hr>
        <h1 class="series">Liquid Coolers</h1>
        <hr>
        <div class="row">
