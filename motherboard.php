...
$res = mysqli_query($conn,"SELECT * FROM products Where binary cat = 'motherboard'");
...
<div class="series text-center ">
            <h1>Motherboards</h1>
            <p>Choose from the best and exclusive collection of Motherboards for best performance. </div>
