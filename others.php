...
$res = mysqli_query($conn,"SELECT * FROM products Where binary cat = 'others'");
...
<div class="series text-center ">
            <h1>Other Acessories</h1>
            <p>Choose from all other acessories for pc build like PSUs, power supplies, RGB fans,etc.</p>
        </div>
